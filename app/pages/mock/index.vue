  ...
  <div class="min-h-screen bg-neutral-50 p-8">
    <div class="mx-auto max-w-6xl">
      <div class="mb-8">
        <NuxtLink
          to="/"
          class="mb-4 inline-flex items-center text-sm text-neutral-500 hover:text-neutral-900"
        >
          ← 返回搜索
        </NuxtLink>
      ...
      <div class="grid gap-6 lg:grid-cols-2">
        <Card class="flex flex-col">
          ...
          <CardContent class="flex-1">
            ...
            <div class="relative">
              <pre
                class="max-h-100 overflow-auto rounded-lg bg-neutral-900 p-4 text-sm text-green-400"
